        ...
        self.conn = tls.connect(self.opt.port, self.opt.server, creds, function() {
           ...
           if (self.conn.authorized ||
              ...
              self.conn.setEncoding('utf-8');
                ...
                if (self.opt.webIrc && self.opt.webIrcHost !== null && self.opt.webIrcIp !== null) {
                    self.send( "WEBIRC", self.opt.webIrcPassword, self.opt.webIrcUser, self.opt.webIrcHost, self.opt.webIrcIp)
                }
